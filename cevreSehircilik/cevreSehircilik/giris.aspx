<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giris.aspx.cs" Inherits="cevreSehircilik.giris" %>

<!DOCTYPE html>
<html lang="en">
   <head>
      <title>serkan bahtiyar </title>
      <!-- Meta tags -->
   ...
   <body>
      <div class="mid-class">
         <div class="art-right-w3ls">
            <h2>Şehir Değerlendirme Yorumlama Admin Login Paneli</h2>
         ...
         <div class="art-left-w3ls">
            <h1 class="header-w3ls">
              Şehir Değerlendirme Yorumlama Admin Sayfası
            </h1>
         </div>
      </div>
      <footer class="bottem-wthree-footer">
         <p>
          2024 serkan bahtiyar
         </p>
      </footer>
   </body>
</html>