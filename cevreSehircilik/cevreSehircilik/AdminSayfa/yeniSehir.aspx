<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="yeniSehir.aspx.cs" Inherits="cevreSehircilik.AdminSayfa.yeniSehir" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" placeholder="Şehir Görsel"></asp:TextBox>
         <br />
        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" DataTextField="turAd" DataValueField="turid" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>
         <br />
